...
builder.Services.AddScoped<IMatchLineupRepository, MatchLineupRepository>(); // ← Evento #4
...
builder.Services.AddScoped<IMatchLineupService, MatchLineupService>(); // ← Evento #4
